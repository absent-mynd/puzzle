...
| Anchors, fold preview band, the placement cursor and its reach, seam diamonds, glue lines, the hold-progress ring, the fuse pulse, loose hands, the burst ring | `WorldOverlay.gd` |
