...
func test_multiple_folds_with_player_moving_between():
	...
	var result1 = fold_system.execute_fold(Vector2i(2, 5), Vector2i(6, 5))
	...
	var result2 = fold_system.execute_fold(Vector2i(2, 7), Vector2i(6, 7))
...
func test_multiple_folds_with_player_always_safe():
	...
	var result2 = fold_system.execute_fold(Vector2i(5, 2), Vector2i(5, 4))
